    ...
    <body>
        <div id="preferenceBackground">
            ...
            <div id="preferenceContent">
                ...
                <?php
                    if(empty($_SESSION['stream']))
                    {
                        header('Location: preferences2.php');
                    }
                ?>

                <form action="preferences4.php" method="POST"style="color: white;">
                    ARE YOU VEGETARIAN OR NON-VEGETARIAN: <br>
                    <input class="prefInput" type="radio" style="height: 4vh; width: 4vw; margin-left:7vw;" name="cuisine" value="veg"> Vegetarian
                    <input class="prefInput" type="radio" style="height: 4vh; width: 4vw;" name="cuisine" value="nVeg"> Non-Vegetarian <br>
