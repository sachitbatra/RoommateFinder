    ...
    <body>
        <div id="preferenceBackground">
            ...
            <div id="preferenceContent">
                ...
                <form action="preferences8.php" method="POST" style="color: white;">
                    ARE YOU FLUENT IN KANNADA: <br>
                    <input class="prefInput" type="radio" style="height: 4vh; width: 4vw; margin-left:14vw;" name="kannada" value="1"> Yes
                    <input class="prefInput" type="radio" style="height: 4vh; width: 4vw;" name="kannada" value="0"> No <br>
